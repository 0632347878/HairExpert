...
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode, ssrRenderAttrs, ssrRenderAttr } from 'file:///Users/mac/anna-hair-expert/node_modules/vue/server-renderer/index.mjs';
...
const _imports_0 = "" + __publicAssetsURL("master.png");
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(_attrs)} data-v-6e8de997><section class="relative section" data-v-6e8de997><div class="section-inner flex flex-row gap-4 justify-center lg:gap-8 max-w-[1280px] md:gap-6 sm:gap-4 mx-auto px-12 w-full" data-v-6e8de997><div class="description-wrapper flex flex-col justify-center lg:py-2 lg:text-left lg:w-full py-52 text-center" data-v-6e8de997><h1 class="heading bg-text font-serif gradient leading-tight text-5xl text-koromiko uppercase xl:leading-tight xl:text-6xl" data-v-6e8de997><span data-v-6e8de997>Anna Kuchma</span><span data-v-6e8de997>Anna Kuchma</span></h1><p class="sm:text-2xl text-white text-xl" data-v-6e8de997> Топ - майстер з реконструкції та естетики волосся </p></div><div class="picture-wrapper h-fit hidden lg:block relative shrink-0 w-fit" data-v-6e8de997><img class="master-picture"${ssrRenderAttr("src", _imports_0)} alt="" data-v-6e8de997></div></div></section></div>`);
}
...
const AppComponent = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-6e8de997"]]);
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./_nuxt/error-404-75cc9b05.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./_nuxt/error-500-a58bedc4.mjs').then((r) => r.default || r));
